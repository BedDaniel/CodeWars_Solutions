...
int main(){
    std::vector<std::string> vec = {"NORTH", "SOUTH", "SOUTH", "EAST", "WEST", "NORTH", "WEST"};
    std::vector<std::string> vec2 = {"NORTH","SOUTH","SOUTH","EAST","WEST","NORTH", "NORTH"};
    std::vector<std::string> vec3 = {"NORTH", "SOUTH", "NORTH", "SOUTH"};
    std::vector<std::string> vec4 = {"NORTH",  "EAST", "SOUTH", "WEST"};
    std::vector<std::string> vec5 = {"NORTH"};
